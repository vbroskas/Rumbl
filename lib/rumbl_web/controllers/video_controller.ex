defmodule RumblWeb.VideoController do
  ...
  @doc """
  use this instead of having to put conn.assigns.current_user everywhere
  this function defines the args that will be input to every function in this controller
  """
  def action(conn, _) do
    args = [conn, conn.params, conn.assigns.current_user]
    # apply function takes the module, the action name, and the arguments
